<x-admin.layout>
    <x-slot name="title">Districts</x-slot>
    <x-slot name="heading">Districts</x-slot>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="edit-element btn text-secondary px-2 py-1" title="Edit district" data-id="{{ $district->id }}"><i data-feather="edit"></i></button>

                                            <button class="btn text-danger rem-element px-2 py-1" title="Delete district" data-id="{{ $district->id }}"><i data-feather="trash-2"></i> </button>
...
<script>
    $("#buttons-datatables").on("click", ".edit-element", function(e) {
        ...
        var url = "{{ route('districts.edit', ":model_id") }}";
...
<script>
    $(document).ready(function() {
        $("#editForm").submit(function(e) {
            ...
            var url = "{{ route('districts.update', ":model_id") }}";
            //
            $.ajax({
                url: url.replace(':model_id', model_id),
                type: 'POST',
...
<script>
    $("#buttons-datatables").on("click", ".rem-element", function(e) {
        ...
        .then((justTransfer) =>
        {
            ...
            {
                var model_id = $(this).attr("data-id");
                var url = "{{ route('districts.destroy', ":model_id") }}";
