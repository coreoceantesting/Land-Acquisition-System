                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="edit-element btn text-secondary px-2 py-1" title="Edit designation" data-id="{{ $designation->id }}"><i data-feather="edit"></i></button>

                                            <button class="btn text-danger rem-element px-2 py-1" title="Delete designation" data-id="{{ $designation->id }}"><i data-feather="trash-2"></i> </button>
