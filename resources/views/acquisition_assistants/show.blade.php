        ...
        <div class="card-body">
            <div class="mb-3 row">
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <input class="form-control" id="project_name" disabled readonly name="project_name" type="text" placeholder="Enter Applicant Name" value="{{ old('project_name', $acquisitionAssistant->project_name) }}">
