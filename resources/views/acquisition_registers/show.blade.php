<x-admin.layout>
    <x-slot name="title">Show Acquisition Register</x-slot>
    <x-slot name="heading">Show Acquisition Register</x-slot>
                ...
                <select name="land_acquisition_id" id="land_acquisition_id" class="form-select" required>
                    ...
                    @foreach($land_acquisitions as $land_acquisition)
                        <option value="{{ $land_acquisition->id }}"
                            {{ old('land_acquisition_id', $acquisition_register->land_acquisition_id ?? '') == $land_acquisition->id ? 'selected' : '' }}>
