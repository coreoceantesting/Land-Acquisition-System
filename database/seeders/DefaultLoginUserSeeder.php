...
class DefaultLoginUserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = Permission::whereIn('id', [49,50,51,52,53,54,57,58,59,60,61,62,63,64,65])->pluck('id','id');
        ...
        $permissions = Permission::whereIn('id', [53,54,55,56,57,58,59,62,63])->pluck('id','id');
